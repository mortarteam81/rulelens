...
assert.ok(teacher.lawKeywords.includes('고등교육법(추론 후보)'), 'teacher row infers higher education law candidate');
assert.ok(teacher.lawKeywords.includes('사립학교법(추론 후보)'), 'teacher row infers private school law candidate');
...
assert.ok(appendix.lawKeywords.includes('대학원 학칙 시행세칙(추론 후보)'), 'appendix row infers graduate school rule candidate');
...
assert.ok(fund.lawKeywords.includes('사립학교법(추론 후보)'), 'fund row infers private school law candidate');
...
assert.ok(research.lawKeywords.includes('산업교육진흥 및 산학연협력촉진에 관한 법률(추론 후보)'), 'research row infers industry-academic cooperation law candidate');
