...
assert.equal(result.rows.length, 3, 'multi-agenda PDF should be grouped into 3 comparison rows, not fragmented rows');
...
console.log(`✓ PDF regression fixture: ${result.rows.length} agenda rows with restored current/revised/note columns`);
